# Cal the dnds value for every single gene
...
ouFile1 = "../test_human_mouse_rat/Data_6.2/Results/omega_ladder.txt"
ouFile2 = "../test_human_mouse_rat/Data_6.2/Results/omega_bin.txt"
ouFig = "../test_human_mouse_rat/Data_6.2/Figure/omega_dis.pdf"

main = function(inDir, ouFile1, ouFile2, ouFig){
