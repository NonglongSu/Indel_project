...
main = function(inD, ouF, omega_l){
  ...
  repeat{
    ...
    nk1 <<- gnumw[,1]/colSums(gnumw)[1]
    nk2 <<- gnumw[,2]/colSums(gnumw)[2]
    ...
    #hjkb(par=gv,fn=LL_min_Z,lower=0,upper=1,control=list(tol=1e-4,info=T))
